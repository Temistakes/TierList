    ...
    function buttonsListener(event) {
        ...
        let newRow = `<div class="row">
                    <div class="row__symbol" style="background: #dde161; box-shadow: 0 0 0.625rem #dde161;">
                        <span class="row__symbol-text rename rename_black" data-length="5">
                            New
                        </span>
                    </div>
                    ...
                    <div class="row__managment">
                        <a href="#" data-izimodal-open="#tier-modal" data-izimodal-transitionin="fadeInDown" class="row__settings-btn">
